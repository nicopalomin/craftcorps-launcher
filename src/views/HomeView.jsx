    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center relative animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="relative z-10 flex flex-col items-center text-center w-full max-w-4xl px-8">
                ...
                <div className="text-xs text-slate-600 mt-1 flex flex-col items-center gap-0.5">
                    <span>
                        Playing as: <span className="text-slate-400 font-bold">{activeAccount?.name}</span>
                    </span>
                    {activeAccount?.uuid ? (
                        <span
                            className="text-[10px] font-mono text-slate-700 select-all hover:text-slate-500 transition-colors"
                            title="Player UUID"
                        >
                            {activeAccount.uuid}
                        </span>
